...
<div class="main">
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top nbar">
    <div class="navbar-header">
      <a class="navbar-brand lspace" href="home.php">RT-CS</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="space"><a href="compiler.php">Compiler</a></li>
      <li class="space"><a href="archive.php">Problem Archive</a></li>
      <li class="space"><a href="Updates.php">Updates</a></li>
      <li class="space"><a href="login.php">Login</a></li>
...
<textarea class="form-control" name="code" rows="10" cols="100"></textarea><br><br>
